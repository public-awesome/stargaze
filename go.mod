...
require (
	...
	github.com/alpe/cosmos-tracing v0.1.1-0.20240611142555-a5f14c0e8369 // indirect
...
replace (
	...
	github.com/cosmos/ibc-go/v7 => github.com/public-awesome/ibc-go/v7 v7.3.2-stargaze
