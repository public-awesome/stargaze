...
type Params struct {
	// Addresses which are whitelisted to modify the priivlege status of contracts
...
var fileDescriptor_72b37a39eca21e75 = []byte{
	...
	0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0x4a, 0xf5, 0x41, 0x2c, 0x88, 0x2e, 0x25, 0x47, 0x2e, 0xb6, 0x80,
	0xc4, 0xa2, 0xc4, 0xdc, 0x62, 0x21, 0x43, 0x2e, 0x91, 0x82, 0xa2, 0xcc, 0xb2, 0xcc, 0x9c, 0xd4,
	0xf4, 0xd4, 0x94, 0xf8, 0xc4, 0x94, 0x94, 0xa2, 0xd4, 0xe2, 0xe2, 0xd4, 0x62, 0x09, 0x46, 0x05,
	0x66, 0x0d, 0xce, 0x20, 0x61, 0x84, 0x9c, 0x23, 0x4c, 0xca, 0x8a, 0x65, 0xc6, 0x02, 0x79, 0x06,
	...
	0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x87, 0xb8, 0x4e, 0x17, 0xc3, 0x27, 0x65, 0x86,
	0x46, 0xfa, 0x15, 0x10, 0xff, 0x94, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x1d, 0x66, 0x0c,
	0x08, 0x00, 0x00, 0xff, 0xff, 0x45, 0x97, 0x65, 0x4d, 0xfb, 0x00, 0x00, 0x00,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrivilegedAddresses) > 0 {
		for iNdEx := len(m.PrivilegedAddresses) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintCron(dAtA, i, uint64(len(m.PrivilegedAddresses[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
