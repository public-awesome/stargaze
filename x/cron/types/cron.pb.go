...
type Params struct {
	...
	AdminAddress []string `protobuf:"bytes,1,rep,name=admin_address,json=adminAddress,proto3" json:"admin_address,omitempty"`
}
...
var fileDescriptor_72b37a39eca21e75 = []byte{
	...
	0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0x4a, 0xf5, 0x41, 0x2c, 0x88, 0x2e, 0x25, 0x63, 0x2e, 0xb6, 0x80,
	0xc4, 0xa2, 0xc4, 0xdc, 0x62, 0x21, 0x65, 0x2e, 0xde, 0xc4, 0x94, 0xdc, 0xcc, 0xbc, 0xf8, 0xc4,
	0x94, 0x94, 0xa2, 0xd4, 0xe2, 0x62, 0x09, 0x46, 0x05, 0x66, 0x0d, 0xce, 0x20, 0x1e, 0xb0, 0xa0,
	0x23, 0x44, 0xcc, 0x8a, 0x65, 0xc6, 0x02, 0x79, 0x06, 0x27, 0xdf, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	...
	0xd5, 0x87, 0xb8, 0x47, 0x17, 0xc3, 0xed, 0x65, 0x86, 0x46, 0xfa, 0x15, 0x10, 0x1f, 0x94, 0x54,
	0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x9d, 0x62, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x1f, 0xdd,
	0xac, 0xd9, 0xed, 0x00, 0x00, 0x00,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AdminAddress) > 0 {
		for iNdEx := len(m.AdminAddress) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AdminAddress[iNdEx])
			copy(dAtA[i:], m.AdminAddress[iNdEx])
			i = encodeVarintCron(dAtA, i, uint64(len(m.AdminAddress[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AdminAddress = append(m.AdminAddress, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
