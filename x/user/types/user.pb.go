...
// source: stakebird/user/v1beta1/user.proto
...
func init() {
	proto.RegisterType((*Vouch)(nil), "stakebird.user.v1beta1.Vouch")
	proto.RegisterType((*Params)(nil), "stakebird.user.v1beta1.Params")
}

func init() { proto.RegisterFile("stakebird/user/v1beta1/user.proto", fileDescriptor_cf76af1c1c9840a9) }
