...
import (
	...
	"github.com/public-awesome/stakebird/x/ethbridge/client"
	"github.com/public-awesome/stakebird/x/ethbridge/types"
...
func (am AppModule) InitGenesis(ctx sdk.Context, cdc codec.JSONMarshaler, _ json.RawMessage) []abci.ValidatorUpdate {
